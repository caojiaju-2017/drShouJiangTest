...
"""
Django settings for DRShiFu project.
...
APPEND_SLASH=False
# ALLOWED_HOSTS = ['127.0.0.1', 'localhost','192.168.2.119','192.168.1.104','115.159.224.102','192.168.1.209','192.168.1.106','sjsfu.com','www.sjsfu.com','www.chuweinews.com']
# Application definition
ALLOWED_HOSTS = ['*']

APPID="wx87574419b4e9bc1f"
APPSECRET ="aafc56da3704d6240ec3bc45e726603e"
# HOST="www.chuweinews.com:8181"
HOST="192.168.2.119:8080"
...
WSGI_APPLICATION = 'DRShiFu.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'ShiFu')
STATIC_ROOT = os.path.join(STATIC_ROOT, 'static')


TempDir = os.path.join(os.getcwd(), 'ShiFu')
