...
$.extend({
    ...
    saveAddress:function (parmas) {
        ...
        var rtnCmd = "/api/user/?Command=Add_Address";
        $.post(rtnCmd, {code: OpenId, phone: contact_phone, address: address_input, name: contact_name, flag: 0},
            function (data)
            {
                ...
                {
                    //
                    location.replace("/user_addresss.html");
                }
