...
$.extend({
    get_current_query:function () {
        $.get("/api/pub/?Command=Query_Orders&ecode=" + Emplyee_Login_Phone + "&pageindex=" + currentPageIndex + "&pagesize=" + currentPageSize + "&state=0&type=9",
            function (data)
            {
                // 检查查询状态
